...
//    public let apiUrl = "https://teewvds053.execute-api.eu-west-3.amazonaws.com"
    ...
    public func create(url: String, newObject: T) async throws -> Void {
    ...
    public func update(url: String, id: String, updatedObject: T) async throws {
    ...
    public func delete(url: String, id: String) async throws {
        guard let url = URL(string: "api" + url + "/" + id) else {
            throw HttpError.serverError
        }
